...
export default function AnimatedFenceMark({
  ...
  return (
    <div className={`flex flex-col gap-1.5 ${className}`}>
      <div className="relative w-full" style={{ aspectRatio: "240 / 56" }}>
      ...
      {showLabel ? (
        <div
          className="font-mono text-[9px] uppercase tracking-[0.22em] opacity-70"
          aria-live="polite"
        >
          {LABELS[active]}
        </div>
  ...
  return (
    ...
    >
      ...
      {[...bay1Pickets, ...bay2Pickets].map((x) => (
        <line key={x} x1={x} y1="18" x2={x} y2="48" strokeWidth="0.75" opacity="0.6" />
      ))}
    </svg>
  );
}
...
function WoodPrivacy() {
  ...
  return (
    ...
    >
      ...
      <rect x="228" y="14" width="6" height="34" fill="currentColor" stroke="none" />
      {/* top cap rail */}
      <line x1="6" y1="17" x2="234" y2="17" strokeWidth="2.5" />
    </svg>
  );
}
...
function ChainLink() {
  return (
    ...
    >
      ...
      <rect x="13" y="20" width="103" height="26" fill="url(#cl-mesh)" stroke="none" />
      <rect x="124" y="20" width="103" height="26" fill="url(#cl-mesh)" stroke="none" />
      {/* posts */}
      <rect x="6" y="14" width="6" height="34" fill="currentColor" stroke="none" />
      <rect x="117" y="14" width="6" height="34" fill="currentColor" stroke="none" />
      <rect x="228" y="14" width="6" height="34" fill="currentColor" stroke="none" />
      {/* top + bottom rails */}
      <line x1="6" y1="20" x2="234" y2="20" strokeWidth="1.25" />
      <line x1="13" y1="46" x2="227" y2="46" strokeWidth="0.9" opacity="0.75" />
    </svg>
  );
}
...
function PvcPrivacy() {
  ...
  return (
    ...
    >
      ...
      <rect x="12" y="16" width="105" height="4" fill="currentColor" opacity="0.95" stroke="none" />
      <rect x="123" y="16" width="105" height="4" fill="currentColor" opacity="0.95" stroke="none" />
      {/* finial line on each post top */}
      <rect x="3" y="11" width="12" height="3" fill="currentColor" stroke="none" />
      <rect x="114" y="11" width="12" height="3" fill="currentColor" stroke="none" />
      <rect x="225" y="11" width="12" height="3" fill="currentColor" stroke="none" />
    </svg>
  );
}
